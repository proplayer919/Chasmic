...
public class CreatureTypeRegistry {
    ...
    public CreatureTypeRegistry() {
        registerCreatureType(new CreatureType("test-zombie", "Test Zombie", EntityType.ZOMBIE, 50, CreatureFamily.UNDEAD, 5.0f, 0f, 0.5f, 0f, TestZombie.class));
        registerCreatureType(new CreatureType("nella", "Nella", EntityType.MAGMA_CUBE, 50000, CreatureFamily.VOLCANIC, 500.0f, 250.0f, 5.0f, 0f, Nella.class));
    }
